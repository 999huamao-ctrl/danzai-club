...
const SAMPLE_ACTIVITIES = [
    ...
    },
    {
        ...
        content: '展示你的蛋仔装扮和游戏技巧，赢取"月度蛋仔王"称号！详情请关注后续公告~'
    }
];
...
function parsePlayerIssue(issue) {
    ...
    return {
        ...
        hobby: extractField(body, '爱好') || '未填写',
        gameMode: extractField(body, '爱玩的游戏模式') || '未填写',
        rank: extractField(body, '游戏段位') || '未填写',
        payment: extractField(body, '氪金等级') || '未填写',
        playTime: extractField(body, '上线时长') || '未填写',
        eggId: extractField(body, '蛋号') || '未填写'
    };
}
    ...
    container.innerHTML = players.map(player => `
        <div class="player-card">
            ...
            <div style="margin-top: 15px;">
                ...
                <span class="player-tag">✨ 乐园成员</span>
            </div>
        </div>
    `).join('');
}
